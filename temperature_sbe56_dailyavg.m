% Plot temperature from Palmyra measured with SBE56 loggers
% July 2020
% Sam Stevenson

[tarr,datarr,sitenames]=readsbe56data_temp;
...
saveas(gcf,'~/Box Sync/PalmyraFieldwork/plots/temperature_sbe56_clean_dailyfilt.fig','fig');
